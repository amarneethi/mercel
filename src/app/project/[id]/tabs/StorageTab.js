...
import {
  Button, Tag, Banner, Modal, FormActions, Form, FormGroup, TextInput, Select,
} from 'aopends';
import { Zap, HardDrive, Database, Server, Plus } from 'lucide-react';

export default function StorageTab({ project }) {
